  ...
  return (
    <footer className="mt-auto bg-neutral-900/90">
      <div className="mx-auto grid max-w-6xl gap-8 px-6 py-12 text-white/80 md:grid-cols-3">
        ...
        <div>
          <h4 className="mb-2 text-sm font-semibold text-secondary-200">الموقع وساعات العمل</h4>
        ...
        <div>
          <h4 className="mb-2 text-sm font-semibold text-secondary-200">تواصل معنا</h4>
          <p className="text-sm">واتساب: 0798522935</p>
